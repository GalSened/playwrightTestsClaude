    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            try:
                ...
                dashboard_page = page.get_by_test_id('dashboard-page')
                ...
                page_title = page.get_by_test_id('page-title')
                ...
                await page.screenshot(path='C:/Users/gals/Desktop/playwrightTestsClaude/dashboard_load_failure.png')
                results['tests'].append({
                    'name': 'Page Load Verification',
                    'status': 'failed',
                    'error': str(e)
            ...
            try:
                ...
                create_suite_btn = page.get_by_test_id('quick-create-suite')
                ...
                reports_btn = page.get_by_test_id('quick-open-reports')
                ...
                await page.screenshot(path='C:/Users/gals/Desktop/playwrightTestsClaude/navigation_failure.png')
                results['tests'].append({
                    'name': 'Quick Actions Navigation',
                    'status': 'failed',
                    'error': str(e)
            ...
            try:
                ...
                last_run_card = page.get_by_test_id('last-run-card')
                ...
                try:
                    ...
                    last_run_status = page.get_by_test_id('last-run-status')
                    ...
                    last_run_duration = page.get_by_test_id('last-run-duration')
                    ...
                    details_link = page.get_by_test_id('last-run-details-link')
            ...
            try:
                ...
                activity_feed = page.get_by_test_id('activity-feed')
                ...
                activity_items = page.get_by_test_id('activity-item')
                activity_empty = page.get_by_test_id('activity-empty')
                ...
                await page.screenshot(path='C:/Users/gals/Desktop/playwrightTestsClaude/activity_feed_failure.png')
                results['tests'].append({
                    'name': 'Activity Feed Verification',
                    'status': 'failed',
                    'error': str(e)
            ...
            await page.screenshot(path='C:/Users/gals/Desktop/playwrightTestsClaude/dashboard_final_state.png')
...
async def main():
    ...
    results_file = 'C:/Users/gals/Desktop/playwrightTestsClaude/dashboard_epu_results.json'
