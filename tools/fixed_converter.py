#!/usr/bin/env python3
"""
Fixed WeSign Test Converter - Properly format converted tests
"""

def create_working_auth_test():
    """Create a properly formatted working auth test"""
    
    working_test = '''"""Login and authentication tests converted from Selenium to Playwright."""
...
def main():
    """Create a properly working auth test file"""
    
    output_path = "C:/Users/gals/seleniumpythontests-1/playwright_tests/tests/auth/test_login_working.py"
    
    print("Creating properly formatted working auth test...")
    
    working_content = create_working_auth_test()
    
    with open(output_path, 'w', encoding='utf-8') as f:
        f.write(working_content)
    
    print(f"Created: {output_path}")
    print("This file uses the proven working pattern and should execute successfully.")
