  ...
  public async analyzePerformance(
    ...
    try {
      ...
      const [
        ...
        this.calculatePerformanceScore(metrics, environment),
        this.detectBottlenecks(metrics, environment),
        this.analyzeTrends(historicalData || this.metricsHistory.slice(-50)),
        this.generateRealTimeAlerts(metrics, environment),
        this.generatePredictiveInsights(metrics, environment, this.metricsHistory)
      ]);
